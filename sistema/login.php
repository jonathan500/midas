    ...
    <div class="container-login">
        ...
        <div class="login-right">
            <div class="login-header">
                ...
                <p>Por favor, loge antes de começar a utilizar nossa plataforma</p>
                <?php
            ...
            <form action="log_login.php" class="login-form" method="post">
                <div class="form-gruop">
                    ...
                    <div class="row prabaixo">
                        ...
                        <div class="col-md-5">
                            <button style="width: 100% !important;" class="btn btn-primary btn-new-primar " type="submit">Entrar</button>
                        </div>
                    </div>
                </div>
            </form>
